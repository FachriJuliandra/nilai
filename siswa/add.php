        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="?m=siswa&s=save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <input type="number" name="nama" class="form-control" placeholder="Nama Siswa" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <select name="kelas_id" class="form-control" required> <option value="">Pilih Kelas</option>
                        <?php
